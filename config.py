...
# Лимиты на общее количество чатов на аккаунт
CHAT_LIMITS = {
    "max_supergroups_per_account": 15,  # Максимум 15 supergroups на аккаунт
    "min_stage_to_join_supergroups": 10,  # Вступать в supergroups с 10 стадии
    # Лимиты по стадиям (стадия -> макс. supergroups)
    "supergroups_by_stage": {
        10: 5,   # На 10-й стадии - до 5 групп
        11: 7,   # На 11-й стадии - до 7 групп
        12: 10,  # На 12-й стадии - до 10 групп
        13: 12,  # На 13-й стадии - до 12 групп
