...
class AddAccountRequest(BaseModel):
    ...
    min_daily_activity: Optional[int] = Field(None, ge=2, le=10, description="Min warmups per day (auto-generated by LLM if not specified)")
    max_daily_activity: Optional[int] = Field(None, ge=2, le=10, description="Max warmups per day (auto-generated by LLM if not specified)")
...
class UpdateAccountRequest(BaseModel):
    ...
    min_daily_activity: Optional[int] = Field(None, ge=1, le=10)
    max_daily_activity: Optional[int] = Field(None, ge=1, le=10)
