...
🚫 НЕ ИСПОЛЬЗУЙ ПОПУЛЯРНЫЕ ФАМИЛИИ:
- Избегай: Иванов, Петров, Смирнов, Кузнецов, Попов, Волков, Соколов, Лебедев, Козлов, Новиков, Сидоров, Михайлов
- Используй менее распространенные: Тарасенко, Рогачёв, Шаповалов, Ермолаев, Калашников, Дроздов, Кудряшов, Беляков, Савельев, Марков, Борисов, Галкин, Фомин, Зайцев, Меркушин, Гаврилов, Никитин, Климов, и т.д.

⚠️ ВАЖНО:
- Варьируй возраст (от 18 до 65)
- Разные профессии, не только IT/офис
- Разный уровень активности (пассивные/активные пользователи)
- Избегай клише
...
🎯 Используй предложенные категории (профессия, возраст, интересы) и добавь креативность."""
